...
$(document).ready(function() {
  function makeTimer() {
    var endTime = new Date("October 31, 2023 02:15:13");
    ...
    var Xmas95 = new Date('October 31, 2023 23:15:30');
...
$(document).ready(function () {
    function makeTimer() {
        var endTime = new Date("October 31, 2023 06:10:28");
        var endTime = (Date.parse(endTime)) / 1000;
        var now = new Date();
        var now = (Date.parse(now) / 1000);
        var timeLeft = endTime - now;
...
$(document).ready(function () {
  function makeTimer() {
      var endTime = new Date("October 31, 2023 11:35:47");
      var endTime = (Date.parse(endTime)) / 1000;
      var now = new Date();
      var now = (Date.parse(now) / 1000);
      var timeLeft = endTime - now;
